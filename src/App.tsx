...
const FaviconSvg = ({ className = "w-8 h-8" }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="nexbrandGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#F9B185" />
        <stop offset="40%" stopColor="#FB4308" />
        <stop offset="100%" stopColor="#1B1614" />
      </linearGradient>
    </defs>
    <circle cx="50" cy="50" r="50" fill="url(#nexbrandGrad)" />
    <g transform="translate(23, 22) scale(0.55)">
      <path d="M 0 0 L 35 0 L 65 50 L 35 100 L 0 100 L 30 50 Z" fill="white" />
      <path d="M 45 0 L 80 0 L 110 50 L 80 100 L 45 100 L 75 50 Z" fill="white" />
    </g>
  </svg>
);

// SVG LOGO: Nexbrand Minimalist Full Logo
const LogoTextSvg = ({ className = "h-8" }) => (
  <svg viewBox="0 0 400 80" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    <g transform="translate(0, 10) scale(0.6)">
      <path d="M 0 0 L 35 0 L 65 50 L 35 100 L 0 100 L 30 50 Z" fill="#FF3C00" />
      <path d="M 45 0 L 80 0 L 110 50 L 80 100 L 45 100 L 75 50 Z" fill="#FFF0E5" />
    </g>
    <text x="85" y="55" fontFamily="'Outfit', sans-serif" fontWeight="900" fontSize="56" letterSpacing="-0.02em">
      <tspan fill="#FFF0E5">Nex</tspan><tspan fill="#FF3C00">brand</tspan>
    </text>
  </svg>
);

// SVG LOGO: Nexbrand Full Logo (Dark Version for Footer)
const LogoTextDarkSvg = ({ className = "h-8" }) => (
  <svg viewBox="0 0 400 80" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    <g transform="translate(0, 10) scale(0.6)">
      <path d="M 0 0 L 35 0 L 65 50 L 35 100 L 0 100 L 30 50 Z" fill="#FF3C00" />
      <path d="M 45 0 L 80 0 L 110 50 L 80 100 L 45 100 L 75 50 Z" fill="#0A0A0A" />
    </g>
    <text x="85" y="55" fontFamily="'Outfit', sans-serif" fontWeight="900" fontSize="56" letterSpacing="-0.02em">
      <tspan fill="#0A0A0A">Nex</tspan><tspan fill="#FF3C00">brand</tspan>
    </text>
  </svg>
);
...
const MarqueeItem = () => (
  <>
    <span>Gestão de Tráfego</span> <span className="text-light/40">•</span>
    <span>Otimização de ROAS</span> <span className="text-light/40">•</span>
    <span>Escala de Vendas</span> <span className="text-light/40">•</span>
    <span>Tracking Avançado</span> <span className="text-light/40">•</span>
    <span>Performance</span> <span className="text-light/40">•</span>
  </>
);
...
export default function App() {
  ...
  return (
    <div className="relative">
      ...
      <a href="https://wa.me/5566999825409" target="_blank" rel="noreferrer" onClick={() => handleTrackEvent('Contact', 'Selo_Flutuante_Centro')} className="global-floating-badge group" aria-label="Agendar Diagnóstico">
        <svg className="global-badge-svg text-white/60 group-hover:text-primary transition-colors duration-300" viewBox="0 0 100 100">
            ...
            <text className="font-black uppercase text-[10.5px] fill-current" style={{letterSpacing: '0.08em'}}>
                <textPath href="#globalBadgePath" textLength="213">NEXBRAND • PERFORMANCE • </textPath>
            </text>
        </svg>
                ...
                <div className="lg:col-span-7">
                    ...
                    <RevealUp delay={0.2}>
                        <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-black leading-[0.95] tracking-normal mb-8 uppercase">
                            Quem não aparece,<br/>
                            <span className="highlight-pill mt-3 text-white">não vende.</span>
                        </h1>
                    </RevealUp>
                    ...
                    <RevealUp delay={0.3}>
                        <p className="text-lg md:text-xl text-white/70 max-w-lg mb-10 font-medium leading-relaxed flex items-start gap-3">
                            ...
                            <span>Gestão de tráfego e posicionamento para clínicas de estética e profissionais que desejam escalar o faturamento e lotar a agenda.</span>
                        </p>
                    </RevealUp>
      ...
      <section className="py-24 md:py-32 px-6 bg-light text-dark relative z-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center relative z-10">
            <RevealUp className="lg:col-span-6 space-y-8">
                ...
                <div className="border-l-4 border-dark pl-5 space-y-4 py-1">
                    <p className="text-dark/90 text-lg md:text-xl font-bold leading-relaxed">
                        O problema não é o seu procedimento, nem o seu espaço. A sua campanha está atraindo curiosos. É preciso um diagnóstico cirúrgico.
                    </p>
                    <p className="text-dark/70 text-base font-medium leading-relaxed">
                        Acabe com as promoções que desvalorizam o serviço e contatos desqualificados. É hora de atrair quem busca e pode pagar pelo seu valor.
                    </p>
                </div>
                <div className="bg-primary text-white border-2 border-dark p-5 shadow-[4px_4px_0px_#121212] max-w-md transform -rotate-1 hover:rotate-0 transition-transform relative">
                    ...
                    <p className="font-bold text-lg md:text-xl tracking-normal">
                        E no final do mês, o WhatsApp está cheio de "qual o valor?". A agenda, com buracos.
                    </p>
                </div>
            </RevealUp>
            ...
            <RevealUp className="lg:col-span-6 relative h-[400px] md:h-[450px]">
                ...
                <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=800&q=80" alt="Análise de Dados" className="absolute inset-0 w-full h-full object-cover border-2 border-dark grayscale contrast-125 z-10" />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            <RevealUp className="max-w-3xl mb-16 text-dark">
                <span className="bg-primary text-dark font-bold px-3 py-1.5 uppercase tracking-widest text-[10px] border-2 border-dark inline-flex items-center gap-2 mb-6 shadow-[2px_2px_0px_#121212]">
                    <Layers className="w-3.5 h-3.5" /> O Método
                </span>
                <h2 className="text-4xl md:text-6xl font-black font-outfit leading-[1] tracking-normal uppercase mb-6">
                    O anúncio é o<br/>último passo.<br/>
                    <span className="text-primary">A estratégia vende antes.</span>
                </h2>
                <p className="text-dark/80 text-lg font-medium border-l-4 border-primary pl-4">
                    Antes de apertar qualquer botão, construímos um posicionamento magnético. Focamos no paciente ideal que busca os seus serviços high-ticket e blindamos a sua clínica contra quem só procura preço.
                </p>
            </RevealUp>
            ...
            <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
                <RevealUp className="brutalist-card p-8 md:p-10 flex flex-col justify-between min-h-[280px] group">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h3 className="font-black text-2xl md:text-3xl font-outfit tracking-normal uppercase">Diagnóstico Clínico & Posicionamento</h3>
                    </div>
                    <ul className="space-y-3 mt-auto">
                        <li className="flex items-start gap-2">
                            <div className="w-2 h-2 bg-primary border border-dark mt-1.5 flex-shrink-0"></div>
                            <p className="text-dark/90 font-medium text-base">Entendimento do seu procedimento mais rentável.</p>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-2 h-2 bg-primary border border-dark mt-1.5 flex-shrink-0"></div>
                ...
                <RevealUp className="brutalist-card p-8 md:p-10 flex flex-col justify-between min-h-[280px] group" delay={0.1}>
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h3 className="font-black text-2xl md:text-3xl font-outfit tracking-normal uppercase">Captação Cirúrgica</h3>
                    </div>
                    <ul className="space-y-3 mt-auto">
                        <li className="flex items-start gap-2">
                            <div className="w-2 h-2 bg-primary border border-dark mt-1.5 flex-shrink-0"></div>
                            <p className="text-dark/90 font-medium text-base">Campanhas segmentadas para o público A/B da sua região.</p>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-2 h-2 bg-primary border border-dark mt-1.5 flex-shrink-0"></div>
                            <p className="text-dark/90 font-medium text-base">Leads que buscam transformação real, não apenas preço.</p>
                        </li>
                    </ul>
                </RevealUp>
                ...
                <RevealUp className="brutalist-card p-8 md:p-10 flex flex-col justify-between min-h-[280px] group" delay={0.2}>
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h3 className="font-black text-2xl md:text-3xl font-outfit tracking-normal uppercase">Anúncios que Geram Desejo</h3>
                    </div>
                    <ul className="space-y-3 mt-auto">
                        <li className="flex items-start gap-2">
                            <div className="w-2 h-2 bg-primary border border-dark mt-1.5 flex-shrink-0"></div>
                            <p className="text-dark/90 font-medium text-base">Criativos que valorizam a beleza e autoridade do seu espaço.</p>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-2 h-2 bg-primary border border-dark mt-1.5 flex-shrink-0"></div>
                ...
                <RevealUp className="brutalist-card p-8 md:p-10 flex flex-col justify-between min-h-[280px] group" delay={0.3}>
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h3 className="font-black text-2xl md:text-3xl font-outfit tracking-normal uppercase">Escala Previsível</h3>
                    </div>
                    <ul className="space-y-3 mt-auto">
                        <li className="flex items-start gap-2">
                            <div className="w-2 h-2 bg-primary border border-dark mt-1.5 flex-shrink-0"></div>
                            <p className="text-dark/90 font-medium text-base">Otimização semanal com foco no retorno, previsibilidade e lucro.</p>
                        </li>
                        <li className="flex items-start gap-2">
                            <div className="w-2 h-2 bg-primary border border-dark mt-1.5 flex-shrink-0"></div>
                            <p className="text-dark/90 font-medium text-base">Ajustes cirúrgicos para atrair cada vez mais e melhor.</p>
                        </li>
                    </ul>
                </RevealUp>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12">
            <RevealUp className="lg:col-span-4">
                ...
                <h2 className="text-4xl md:text-5xl font-black font-outfit tracking-normal uppercase leading-[1] mb-6">
                    Critérios de parceria.
                </h2>
                <p className="text-white/70 font-medium text-base leading-relaxed">
                    Não assumimos qualquer clínica. A nossa operação exige um nível de entrega e profissionalismo de ponta que apenas profissionais dedicados possuem.
                </p>
            </RevealUp>
            ...
            <div className="lg:col-span-8 grid md:grid-cols-2 gap-6">
                <RevealLeft className="bg-primary text-dark border-2 border-dark p-6 md:p-8 shadow-[4px_4px_0px_#FEF7EF] flex flex-col hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_#FEF7EF] transition-all">
                    <h3 className="text-2xl font-black font-outfit uppercase mb-6 pb-3 border-b-2 border-dark">A Nexbrand é para quem:</h3>
                    <ul className="space-y-4 flex-grow">
                        <li className="flex items-start gap-3">
                            <Check className="w-5 h-5 flex-shrink-0 mt-0.5" />
                            <p className="font-bold text-base">Tem uma clínica ou consultório e procura escala real.</p>
                        </li>
                        <li className="flex items-start gap-3">
                            <Check className="w-5 h-5 flex-shrink-0 mt-0.5" />
                            <p className="font-bold text-base">É um excelente profissional, mas trava na atração de pacientes.</p>
                        </li>
                        <li className="flex items-start gap-3">
                            <Check className="w-5 h-5 flex-shrink-0 mt-0.5" />
                            <p className="font-bold text-base">Quer parar de brigar por preço e focar em procedimentos high-ticket.</p>
                        </li>
                    </ul>
                </RevealLeft>
                ...
                <RevealRight className="bg-white text-dark border-2 border-dark p-6 md:p-8 shadow-[4px_4px_0px_#FEF7EF] flex flex-col hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_#FEF7EF] transition-all opacity-95">
                    <h3 className="text-2xl font-black font-outfit uppercase mb-6 pb-3 border-b-2 border-dark">Não somos para si se:</h3>
                    <ul className="space-y-4 flex-grow">
                        <li className="flex items-start gap-3">
                            <X className="w-5 h-5 flex-shrink-0 mt-0.5 text-primary" />
                            <p className="font-bold text-base">Acredita em clínicas lotadas da noite para o dia com "hacks".</p>
                        </li>
                        <li className="flex items-start gap-3">
                            <X className="w-5 h-5 flex-shrink-0 mt-0.5 text-primary" />
                            <p className="font-bold text-base">Presta um mau atendimento e acha que o marketing vai salvá-lo.</p>
                        </li>
                        <li className="flex items-start gap-3">
                            <X className="w-5 h-5 flex-shrink-0 mt-0.5 text-primary" />
                            <p className="font-bold text-base">Não tem estrutura para receber a alta demanda de pacientes.</p>
                        </li>
                    </ul>
                </RevealRight>
            </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16 relative z-10">
            <RevealLeft className="relative w-full max-w-[380px]">
                ...
                <div className="aspect-[3/4] border-2 border-dark bg-white relative z-10 overflow-hidden group">
                    <img src="/carlos.jpg" alt="Carlos Henrique - Founder & CEO" className="w-full h-full object-cover grayscale opacity-90 transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0 group-hover:opacity-100" />
                </div>
            ...
            <RevealRight className="space-y-8 lg:flex-1">
                ...
                <div className="bg-white border-2 border-dark p-6 md:p-8 shadow-[4px_4px_0px_#121212] max-w-2xl relative">
                    ...
                    <p className="text-xl md:text-2xl leading-snug font-bold relative z-10 pt-4">
                        "Meu objetivo não é ser apenas um apertador de botões, mas sim colocar estratégias que tragam resultados para clínicas e profissionais de estética."
                    </p>
                </div>
            ...
            <RevealUp delay={0.2} className="inline-block relative">
                <div className="bg-white border-2 border-dark p-4 md:p-6 inline-flex items-center gap-4 shadow-[4px_4px_0px_#FF3C00] transform rotate-1">
                    ...
                    <p className="text-dark text-lg md:text-xl font-bold uppercase tracking-normal text-left">
                        Abrimos apenas <span className="text-primary font-black">2 novas vagas</span> por mês<br className="hidden md:block" /> para gestão de tráfego. 
                    </p>
                </div>
            </RevealUp>
